...
public class Controller {
    private Stage stage;
    @FXML
    TableView<NumGen> tableView;
    @FXML
    private TableColumn<NumGen, String> col1;
    @FXML
    private TableColumn<NumGen, String> col2;
    @FXML
    ...
    ObservableList<NumGen> items = FXCollections.observableArrayList();
    ...
    public void initialize() {
        ...
        col1.setOnEditCommit(event -> ((NumGen) event.getTableView().getItems().get(event.getTablePosition().getRow())).setNum1(event.getNewValue()));
    ...
    public void addRandomNums () {
        ...
        for (int i = 1; i < COUNT_ROW+1; i++) {
            ...
            items.add(new NumGen(String.valueOf(randomNum), solveTheTaskRandom(randomNum,sum, multiplication, a, b)));
        }
